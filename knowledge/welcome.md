---
type: Document
title: Welcome to Askari's Restaurant
description: Introduction to our restaurant knowledge base.
status: stable
order: 1
generated:
  by: human:aliaskari
...
This knowledge base will include:

- **[Menu](menu.md)** — Our Pakistani/desi cuisine offerings with ingredients and allergen information
- **[Allergens and dietary information](allergens-and-dietary.md)** — Complete allergen and dietary tags for every menu item
- **[Reservation policy](policies/reservations.md)** — How to book a table and what to expect
- **[Refund and cancellation policy](policies/refunds-and-cancellations.md)** — Our terms for changes and cancellations
- **[Operating hours](hours-and-location.md)** — When we're open and how to reach us
- **[Frequently asked questions](faq.md)** — Common customer questions answered
